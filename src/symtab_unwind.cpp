 ...
 *
 * Mass Effect Infiltrator links its own copy of libgcc's ARM unwinder, so throwing is
 ...
 * libmasseffect.so is not in that list and never can be: this loader mapped it
 ...
 *
 * That is exactly how Mass Effect Infiltrator was dying at M4. xt::TextureLoader::loadTexture2D
 ...
 *
 * Minigore 2 never needed this. Same engine, same unwinder - it simply never
...
extern "C" uintptr_t masseffect_unwind_find_exidx(uintptr_t pc, int *pcount)
{
...
DynLibFunction symtable_unwind[] = {
    ...
    NO_THUNK("__gnu_Unwind_Find_exidx", (uintptr_t)&masseffect_unwind_find_exidx),
#endif
    { NULL, 0 },
};
